...
if [ $2 -lt 4 ]
then
	python3 training/training.py --epoch 2000 --batch 1024 --modelName ${networks[$2]} --modelType MLP --cluster $1 --version 0.0.1
else
	python3 training/training.py --epoch 2000 --batch 1024 --modelName ${networks[$2]} --modelType MODELS --cluster $1 --version 0.0.1 
fi
