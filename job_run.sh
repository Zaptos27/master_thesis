...
for network in conv1d_rnn conv1d conv2d convlstm1d depthwise_conv1d gru lstm mlp_conv mlp_deep_wide mlp_deep mlp_piecewise mlp_repeat mlp_wide mlp rnn separable_conv1d separable_conv2d stacked_gru stacked_rnn 
do
