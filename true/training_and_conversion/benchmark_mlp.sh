...
#done
#date
for j in 1 2 4 8 16 32 64 128 256 512 1024 2048 4096 8192 32768 65536
do
	python3 benchmark.py --batch $j --network mlp_single --cluster $1 --code_generation --target cuda --amount 100 --old_cluster 7234748 --version 1.1.0
	date
done
python3 benchmark.py --batch 16384 --network mlp_single --cluster $1 --code_generation --target cuda --amount 100 --old_cluster 7234748 --version 1.1.0 --output
for j in 1 2 4 8 16 32 64 128 256 512 1024 2048 4096 8192 16384 32768 65536
do
	#python3 benchmark.py --batch $j --network mlp_single --cluster $1 --code_generation --target opencl --amount 100 --old_cluster 7234748 --version 1.1.0
	#date
	python3 benchmark.py --batch $j --network mlp_single --cluster $1 --code_generation --target llvm --amount 100 --old_cluster 7234748 --version 1.1.0
	date
done
