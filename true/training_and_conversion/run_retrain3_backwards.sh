...
if [ $2 -lt 3 ]
then
	python3 training/training.py --windowSize 3 --epoch 60 --batch 4096 --modelName ${networks[$2]} --modelType MLP --steps 20000 --cluster $1 --version 1.0.1 --retrain --old_cluster 7217782
else
	python3 training/training.py --windowSize 3 --epoch 60 --batch 4096 --modelName ${networks[$2]} --modelType MODELS --steps 20000 --cluster $1 --version 1.0.1 --retrain --old_cluster 7217782
fi
