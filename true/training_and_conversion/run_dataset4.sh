...
if [ $2 -lt 3 ]
then
	python3 training/training.py --epoch 1000 --batch 4096 --modelName ${networks[$2]} --modelType MLP --cluster $1 --version 0.1.0
else
	python3 training/training.py --epoch 1000 --batch 4096 --modelName ${networks[$2]} --modelType MODELS --cluster $1 --version 0.1.0 
fi
